    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
            ...
            <div class="table-responsive">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <ul class="table-controls">
                                        ...
                                        <li>
                                            <form action="{{ route('admin.faqs.destroy', ['faq' => $faq->id]) }}" method="POST" class="d-inline-block">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn-delete" data-toggle="tooltip" title="Delete" onclick="return confirm('Are you sure want to delete the FAQ?');">
                ...
                {{ $faqs->appends(request()->except('faq'))->render() }}
            </div>
        </div>
    </div>
</div>
